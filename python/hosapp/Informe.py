...
def generar_pdf(orden):
    ...
    data5 = [[parrafo('<b>CONCEPTO</b>', 9), parrafo('<b>CERTIFICADO DE REGISTRO PRESUPUESTAL</b>', 7), '', '', ''],
             ...
             ['', parrafo("%s"%(rubro), 8.5), '', parrafo("$ %s"%(a_cifra(compromiso)), 8.5), '']]
    ...
    data6 = [[parrafo("<b>EN LETRAS SON:</b><br /><font size=9.5> %s M/L</font>"%(toWord(int(get_discriminacion(bien_servicio, monto, orden.discriminacion[0], orden.discriminacion[0].pago_final)[1]))), 9, TA_LEFT)]]
    ...
    data13 = [[parrafo(texto, 8.5, TA_LEFT), parrafo(get_discriminacion(bien_servicio, monto, orden.discriminacion[0], orden.discriminacion[0].pago_final)[0], 8.5, TA_LEFT), parrafo('<b>RECIBI:</b>', 9, TA_LEFT)],
