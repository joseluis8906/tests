...
class MyFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        staticbox_fila11 = wx.StaticBox(self.panel_contenedor, -1, u'Descuentos y adiciones', (5,435), (580,85))
    ...
    def sobre_escribir(self, orden):
        ...
        if unicode(orden.rubro).__len__()>0:
            self.text_rubro.SetValue(unicode(orden.rubro))
    ...
    def post_guardado(self):
        ...
        self.grid_cerdisp.SetCellValue(2,0,'')
        self.grid_cerdisp.SetCellValue(2,1,'')
        self.grid_cerdisp.SetCellValue(2,2,'')
        self.grid_cerdisp.SetCellValue(2,3,'')
        ...
        self.grid_cerreg.SetCellValue(2,0,'')
        self.grid_cerreg.SetCellValue(2,1,'')
        self.grid_cerreg.SetCellValue(2,2,'')
        self.grid_cerreg.SetCellValue(2,3,'')
        self.text_concepto.SetValue('')
        self.text_comprobante.SetValue('')
        self.date_fechacomp.SetValue(wx.DateTime().Today())
        self.text_rubro.SetValue('')
        ...
        self.text_monto.SetValue('')
        self.check_pago_final.SetValue(False)